  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Chiranjib Sahoo</strong> — an aspiring{" "}
        ...
        <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.8)" }}>Along with AI/ML, I have experience in <strong>backend development</strong>, building scalable APIs and integrating machine learning models into real-world applications using modern web technologies. I enjoy designing end-to-end intelligent systems — from data processing and model development to backend deployment and API integration.</p>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>M.I.T.M (Modern Institute Of Technology And Management)</strong> — Bhubaneswar,
                  Odisha
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>G.S.C. Gandhi Science College</strong> — Bhubaneswar, Odisha
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                 CHSE Board | Percentage: 75%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>A.G.H.S.                         Achyutananda Govt. High School</strong> — Angul,
                  Odisha
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                 BSE Board | Percentage: 69%
                </p>
