...
const IMAGES = {
  personal: [
    {
      ...
      photos: ["/gallery/Barunei.jpeg", "/gallery/Barunei1.jpeg","/gallery/Barunei2.jpeg"],
    },
    {
      id: 2,
      caption:
        "Weekend getaway to clear my head 🌄 Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/My.jpeg", "/gallery/My1.jpeg"],
    },
  ],
  projects: [
    {
  ...
  achievements: [
    {
      id: 1,
      caption: "Internshala Student Partner Program 🚀!",
      photos: ["/gallery/INS.jpeg"],
    },
    {
      id: 2,
      caption: "Acmegrade Campus Ambassador ❤️‍🔥",
      photos: ["/gallery/AG.jpg"],
    },
  ],
};
